defmodule MmoaigWeb.Router do
  use MmoaigWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {MmoaigWeb.Layouts, :root}
  ...
  # scope "/api", MmoaigWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:mmoaig, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: MmoaigWeb.Telemetry
